...
def game_hash
  ...
  final_hash[:away][:players].push(:player_name => "Bismack Biyombo",
  :number => 0,
  :shoe => 16,
  :points => 12,
  :rebounds => 4,
  ...
  final_hash[:away][:players].push(:player_name => "DeSagna Diop",
  :number => 2,
  :shoe => 14,
  :points => 24,
  :rebounds => 12,
  ...
  final_hash[:away][:players].push(:player_name => "Ben Gordon",
  :number => 8,
  :shoe => 15,
  :points => 33,
  :rebounds => 3,
  ...
  final_hash[:away][:players].push(:player_name => "Kemba Walker",
  :number => 33,
  :shoe => 15,
  :points => 6,
  :rebounds => 12,
